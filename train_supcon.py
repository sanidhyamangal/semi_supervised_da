...
def train_model(args) -> None:
    ...
    supercon_dataloader = LoadSuperConData(args.path_to_data_dir,image_shape=(args.height, args.width), channel=args.channel)

    supercon_dataset = supercon_dataloader.create_dataset(args.batch_size, autotune=AUTOTUNE)
