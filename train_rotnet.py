...
train_dataset = tf.keras.preprocessing.image_dataset_from_directory(TEST_SET, image_size=(244,244),batch_size=64)
...
rotnet.fit_generator(train_dataset, epochs=500, callbacks=[tb_callback, ckpt_callback])
